...
Tabbycat is **currently unavailable as a 1-click installation** on the [Heroku](https://www.heroku.com/deploy?template=https://github.com/vijaturulyte/tabbycat) web platform. If you are unable to use Calico, we suggest [creating a local installation](https://tabbycat.readthedocs.io/en/stable/install/local.html). We hope to address this issue or [develop an alternate installation method](https://tabbycat.readthedocs.io/en/feature-render/index.html) in a future version of Tabbycat.
